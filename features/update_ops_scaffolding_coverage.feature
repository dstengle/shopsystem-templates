Feature: shop-templates update — ops scaffolding coverage
  ...
  @scenario_hash:3e8c8087c483db9e @bc:shopsystem-templates
  ...
  @scenario_hash:ebbe3f1b92258299 @bc:shopsystem-templates
  ...
  @scenario_hash:59d41246cbd5235b @bc:shopsystem-templates
