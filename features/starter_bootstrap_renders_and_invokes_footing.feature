Feature: the starter bin/bootstrap obtains bin/footing by rendering it before invoking it (lead-y4pg)
  ...
  @scenario_hash:b05fff82d0d10f4a @bc:shopsystem-templates
  ...
  @scenario_hash:3646efa06051fcac @bc:shopsystem-templates
  ...
  @scenario_hash:c15aeb90b21357e5 @bc:shopsystem-templates
