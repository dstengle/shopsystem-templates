Feature: lead-architect template grounds empirical pre-state verification in the contract/artifact surface (ADR-018 D1/D2)
  ...
  @scenario_hash:489fe7b30c010cab @bc:shopsystem-templates
  ...
  @scenario_hash:9de387f9fc77ca3a @bc:shopsystem-templates
  ...
  @scenario_hash:3f096e334ceb77f2 @bc:shopsystem-templates
  ...
  @scenario_hash:7d7f4bd2c88e5f0a @bc:shopsystem-templates
  ...
  @scenario_hash:96cf1667aec9a98f @bc:shopsystem-templates
